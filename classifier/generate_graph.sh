...
python object_detection/export_inference_graph.py --input_type image_tensor --pipeline_config_path real/model_rcnn/faster_rcnn_resnet101_coco.config  --trained_checkpoint_prefix real/model_rcnn/model.ckpt-10567 --output_directory traffic_light_graph_real
